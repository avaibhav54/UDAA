...
<html>
    ...
    <body id="ask">
            ...
            <div id="sf">
                <center>
                    <div class="heading ask">
                        <h1><div id="ntro">Udaan</div></h1>
                        <p id="tag-line">For VITians, By VITians</p>
                    </div>

                    <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data">

                        <input name="question" type="text" title="Your Question..." placeholder="Ask your questions here" id="question">

                        <select name="cat">
                            <option valus="Category">Category</option>
                            <option value="Algorithms">DSA</option>
                            <option value="Architecture">CAO</option>
        ...
        <div id="ask-ta">
            <h1>Thank You.<br>Stay tunned for future updates.</h1>
        </div>
